...
In [Part 1](/reverse-engineering-evm-storage.html), I wrote that multiple trace passes were necessary to collect the state diff, ordered writes, call-frame attribution, and hash preimages SlotScan needs.
