---
layout: post
title: Hijacking a Safe Address Despite CREATE2
date: 2025-01-29 00:00:00
author: Ryan Miller
description: How an attacker can claim an uninitialized Safe proxy at its expected deterministic address.
tags:
- Security
- Safe
- CREATE2
...
<p align="center" >
    <img src="/static/img/posts/safe-deployment-happy-path.png" alt="Normal deterministic Safe deployment flow" width="650"/>
...
<p align="center" >
    <img src="/static/img/posts/safe-address-hijack.png" alt="Safe address hijacking flow when the implementation is missing" width="650"/>
    <em style="color: #808080;"><br/>
        Safe address theft.
    </em>
</p>
